...
class CommentManager extends Manager
{
	...
	{
		$db = $this->dbConnect();
        $comments = $db->prepare('INSERT INTO comments(post_id, author, comment, comment_date, publishable) VALUES(?, ?, ?, NOW(), 0)');
	...
	public function moderateComment($modCommentid, $publishComment)
	{
		...
		$affectedLines =  $req->execute(array($publishComment, $modCommentid));
