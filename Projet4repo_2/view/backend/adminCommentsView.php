...
<div class="container">
    ...
    ?>
        ...
        <div class="row">
            <form action="index.php?action=moderate&amp;id=<?= $comment['id'] ?>" method="post">
                <input type="radio" name="publishComment" value="oui" id="publishComment"/><label for="oui">Valider le commentaire</label>
                <input type="radio" name="publishComment" value="non" id="publishComment"/><label for="non">Supprimer le commentaire</label>
...
<div class="container">
    ...
    {
    ?>  
        <p><?= filter_var($modComment['id']); ?></p>
        <p><?= filter_var($modComment['post_id']); ?></p>
