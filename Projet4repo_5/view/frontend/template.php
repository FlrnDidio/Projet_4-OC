	          ...
	          <li>
          		...
          		if(isset($_SESSION['pseudo'])) {
					...
					<?php
          			...
          			?>
          			<a href="index.php?action=showPublicLogIn">Se connecter</a>
          			<?php
          		}
           		?>
   			  </li>
	    ...
	    <div class="container">
	      <div class="row">
	        <div class="col-md-12 col-lg-12">
	          ...
	          <a href="index.php?action=showLog">Espace Admin</a>
	          <p>&copy;SquadFREE. All rights reserved. <br /> Site réalisé dans le cadre d'une formation de développement web par Florian Didio.
	          </p>
	          <div class="credits">
	            <!--
